...
| TC-B-03 | Validate top story score >= second story | Ranking order validation (handles algorithm complexity) |
| TC-B-04 | Validate top stories have valid scores | Scores exist and are numeric for top stories |
...
No test data is required as tests use the live production site. Tests are data-driven by actual Hacker News content, which ensures realistic testing scenarios.
...
- **Low Risk**: Sorting validation (depends on live data and ranking algorithm)
